...
class _CustomTravellingPlanState extends State<CustomTravellingPlan> {
  ...
  Future pickDateRange() async {
    ...
    final dialogHeight =
        screenHeight * 0.6; // Adjust the dialog height as needed
    final dialogTopOffset =
        screenHeight * 0.2; // Adjust the top offset as needed
          ...
          child: SizedBox(
            ...
            child: Column(
              children: [
                ...
                Expanded(child: child ?? const SingleChildScrollView()),
              ],
            ),
          ),
        );
