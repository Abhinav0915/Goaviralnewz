...
import 'package:goaviralnews/features/navigation/screens/Food/RestaurantOverviewPage.dart';

class RestaurantDetailsPage extends StatefulWidget {
  const RestaurantDetailsPage({Key? key});

  static const String routName = "/restaurantdetails-page";
          ...
          Expanded(
            ...
            child: TabBarView(
              ...
              children: const [
                ...
                Center(child: Text('Photoooooooo')),
                Center(child: Text('Reviewwwwwwwwwwwww')),
                Center(child: Text('Directionnnnnnnnnn')),
              ],
            ),
          ),
        ],
