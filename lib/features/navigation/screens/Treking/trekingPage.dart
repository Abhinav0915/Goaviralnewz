...
class TrekingPage extends StatefulWidget {
  const TrekingPage({Key? key}) : super(key: key);

  static const String routName = "/treking-page";

  @override
  State<TrekingPage> createState() => _TrekingPageState();
}

class _TrekingPageState extends State<TrekingPage> {
  @override
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                ...
                image: DecorationImage(
                  image: AssetImage("assets/images/trekk.jpg"),
                  fit: BoxFit.cover,
                ),
              ),
              child: Stack(
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              image: const DecorationImage(
                                image: AssetImage("assets/images/trrek1.webp"),
                                fit: BoxFit.cover,
                              ),
                            ),
                          ),
                        ...
                        children: [
                          Container(
                            ...
                            decoration: BoxDecoration(
                              borderRadius: BorderRadius.circular(8),
                              image: const DecorationImage(
                                image: AssetImage("assets/images/trek2.jpg"),
                                fit: BoxFit.cover,
                              ),
                            ),
                          ),
                        ...
                        children: [
                          Container(
                            ...
                            decoration: BoxDecoration(
                              borderRadius: BorderRadius.circular(8),
                              image: const DecorationImage(
                                image: AssetImage("assets/images/trek3.jpg"),
                                fit: BoxFit.cover,
                              ),
                            ),
                          ),
